...
def rate_offer_from_db(row: dict[str, Any]) -> RateOffer:
    ...
    return RateOffer(
        ...
        collection_location_code=row.get("collection_location_code"),
        collection_location_name=metadata.get("collection_location_name"),
        pol=row.get("pol"),
        pod=row.get("pod"),
        final_destination=row.get("destination"),
        destination_location_code=row.get("destination_location_code"),
        destination_location_name=metadata.get("destination_location_name"),
